# Highlight
Highlight is a Chrome extension and a standalone tool for highlighting text on any website and for managing those highlights, based on the [annotator.js](http://annotatorjs.org/) project.
